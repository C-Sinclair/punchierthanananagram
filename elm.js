			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Punchier Than An Anagram')
							])),
						A2(
						$elm$html$Html$p,
						_List_Nil,
						_List_fromArray(
							[
								$elm$html$Html$text('You\'ve reached the website for the '),
								A2(
								$elm$html$Html$i,
								_List_Nil,
								_List_fromArray(
									[
										$elm$html$Html$text('amazing')
									])),
								$elm$html$Html$text(' comedy duo behind such hits as Bibblin\' and Public Service Announcement!')
							])),
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Hi Joe!')
							]))
					]))
			]),
		aB: 'PunchierThanAnAnagram'
	};
};
